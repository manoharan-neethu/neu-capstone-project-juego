'''
Answers:
	flag:  juegoCTF{Charlie_Brown_32535}
	ASCII: 106 117 101 103 111 67 84 70 123 67 104 97 114 108 105 101 95 66 114 111 119 110 95 51 50 53 51 53 125
	BIN:   01101010 01110101 01100101 01100111 01101111 01000011 01010100 01000110 01111011 01000011 01101000 01100001 01110010 01101100 01101001 01100101 01011111 01000010 01110010 01101111 01110111 01101110 01011111 00110011 00110010 00110101 00110011 00110101 01111101
	HEX:   0x6A 0x75 0x65 0x67 0x6F 0x43 0x54 0x46 0x7B 0x43 0x68 0x61 0x72 0x6C 0x69 0x65 0x5F 0x42 0x72 0x6F 0x77 0x6E 0x5F 0x33 0x32 0x35 0x33 0x35 0x7D
	OCTAL: 0o152 0o165 0o145 0o147 0o157 0o103 0o124 0o106 0o173 0o103 0o150 0o141 0o162 0o154 0o151 0o145 0o137 0o102 0o162 0o157 0o167 0o156 0o137 0o63 0o62 0o65 0o63 0o65 0o175
'''
import socketserver
import time
import sys
...
class challenge():
	...
	def octalToAscii(  self ):
		...
		asciiGuess = ''
		##Correct string
		asci = '106 117 101 103 111 67 84 70 123 67 104 97 114 108 105 101 95 66 114 111 119 110 95 51 50 53 51 53 125'
	...
	def hexToBin ( self ):
		##correct used to break out of while loop
		correct = 0
		binary = '01101010 01110101 01100101 01100111 01101111 01000011 01010100 01000110 01111011 01000011 01101000 01100001 01110010 01101100 01101001 01100101 01011111 01000010 01110010 01101111 01110111 01101110 01011111 00110011 00110010 00110101 00110011 00110101 01111101'
		##string to store users guess
		binGuess = ''
		##Proper answer (Remove the 0x?)
		hexi = '0x6A 0x75 0x65 0x67 0x6F 0x43 0x54 0x46 0x7B 0x43 0x68 0x61 0x72 0x6C 0x69 0x65 0x5F 0x42 0x72 0x6F 0x77 0x6E 0x5F 0x33 0x32 0x35 0x33 0x35 0x7D' 
